...
public class ItemDropTest : QuangMonoBehaviour
{
    public JunkCtril junkCtril;
    ...
    {
        base.Start();
        InvokeRepeating(nameof(this.Dropping), 2, 0.2f);
    }
    ...
    protected virtual void Dropping()
    {
        ...
        List<ItemDropRate> dropItems = ItemDropSpawner.Instance.Drop(this.junkCtril.ShootableObject.dropList, dropPos, dropRot);
